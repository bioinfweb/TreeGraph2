...
/**
 * <p>Changes the IDs of a specified group of labels.</p>
 * <p>This class should only be used to change the IDs of labels and not to rename an ID in the 
 * document, because it informs document listeners only about general changes in the document and not
 * about a renamed ID. For this case {@link RenameDataIDEdit} should be used.</p>
 *  
