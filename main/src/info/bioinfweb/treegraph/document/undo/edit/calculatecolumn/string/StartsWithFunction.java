...
public class StartsWithFunction extends AbstractStringFunction {
	public StartsWithFunction(CalculateColumnEdit edit) {
		super(edit);
	}
	...
	protected Object calculate(String text, Object[] additionalParameters) throws ParseException {
		return codeBoolean(text.startsWith(checkString(additionalParameters[0])));
	}
