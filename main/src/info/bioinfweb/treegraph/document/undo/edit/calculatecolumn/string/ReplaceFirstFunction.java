...
public class ReplaceFirstFunction extends AbstractStringFunction {
	public ReplaceFirstFunction(CalculateColumnEdit edit) {
		super(edit);
	}
	...
	protected Object calculate(String text, Object[] additionalParameters) throws ParseException {
		return text.replaceFirst(
				Matcher.quoteReplacement(checkString(additionalParameters[0])), checkString(additionalParameters[1]));
	}
