...
public class ReplaceAllFunction extends AbstractStringFunction {
	public ReplaceAllFunction(CalculateColumnEdit edit) {
		super(edit);
	}
	...
	protected Object calculate(String text, Object[] additionalParameters) throws ParseException {
		return text.replace(checkString(additionalParameters[0]), checkString(additionalParameters[1]));
	}
