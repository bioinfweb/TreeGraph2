...
public class ContainsFunction extends AbstractStringFunction {
	public ContainsFunction(CalculateColumnEdit edit) {
		super(edit);
	}
	...
	protected Object calculate(String text, Object[] additionalParameters) throws ParseException {
		return codeBoolean(text.contains(checkString(additionalParameters[0])));
	}
