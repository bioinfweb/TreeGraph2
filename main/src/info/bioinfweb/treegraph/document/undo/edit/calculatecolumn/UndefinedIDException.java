...
/**
 * This exception is thrown by the methods of {@link CalculateColumnEdit} if an undefined ID column 
 * is referenced in an expression.
 * @author Ben St&ouml;ver
 * @since 2.0.24
 */
public class UndefinedIDException extends ParseException {
	...
	public UndefinedIDException(Token currentTokenVal, int[][] expectedTokenSequencesVal, 
