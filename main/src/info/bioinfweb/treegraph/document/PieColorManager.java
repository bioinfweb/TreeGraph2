...
public class PieColorManager {
  public static final Color[] DEFAULT_COLORS = {Color.BLUE, Color.RED, Color.GREEN, Color.ORANGE, 
  	Color.CYAN, Color.MAGENTA, Color.YELLOW, Color.PINK};  //TODO Farben evtl. �berarbeiten
 
  
  private static PieColorManager firstInstance = null;
  
  private List<Color> colors = new Vector<Color>();  //TODO Sp�ter erlauben mit benutzerdefinierten Werten zu belegen
