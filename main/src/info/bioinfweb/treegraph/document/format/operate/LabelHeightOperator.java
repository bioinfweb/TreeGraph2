 ...
 * @since 2.0.25
 */
public class LabelHeightOperator extends AbstractGraphicalLabelOperator implements FormatOperator {
  private DistanceValue height = null;

  
	public LabelHeightOperator(DistanceValue height) {
		super();
		this.height = height;
	}
	...
	protected void doApplyTo(ElementFormats format) {
		((GraphicalLabelFormats)format).getHeight().assign(height);
	}
}