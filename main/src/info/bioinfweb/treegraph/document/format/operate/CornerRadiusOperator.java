 ...
 */
public class CornerRadiusOperator extends AbstractOperator implements FormatOperator {
  private DistanceValue cornerRadius = null;

  
	public CornerRadiusOperator(DistanceValue cornerRadius) {
		super();
	...
	protected void doApplyTo(ElementFormats format) {
		((CornerRadiusFormats)format).getCornerRadius().assign(cornerRadius);
	}

	
	public boolean validTarget(ElementFormats format) {
		return format instanceof CornerRadiusFormats;
	}
}