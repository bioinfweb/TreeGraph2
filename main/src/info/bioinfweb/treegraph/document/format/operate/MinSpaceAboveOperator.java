...
public class MinSpaceAboveOperator extends AbstractBranchOperator implements FormatOperator {
  private DistanceValue spaceAbove = null;

  
	public MinSpaceAboveOperator(DistanceValue spaceAbove) {
		super();
	...
	protected void doApplyTo(ElementFormats format) {
		((BranchFormats)format).getMinSpaceAbove().assign(spaceAbove);
	}
}