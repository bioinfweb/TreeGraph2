...
public class LabelLineNumberOperator extends AbstractLabelOperator implements FormatOperator {
  private int lineNumber;

  
	public LabelLineNumberOperator(int lineNumber) {
		super();
	...
	protected void doApplyTo(ElementFormats format) {
		((LabelFormats)format).setLineNumber(lineNumber);
	}
}