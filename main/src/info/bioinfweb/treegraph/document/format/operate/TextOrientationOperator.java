...
public class TextOrientationOperator extends AbstractLegendOperator implements FormatOperator {
  private TextOrientation orientation = null;
	...
	protected void doApplyTo(ElementFormats format) {
		((LegendFormats)format).setOrientation(orientation);
	}
}