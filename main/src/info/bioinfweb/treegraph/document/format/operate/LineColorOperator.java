...
public class LineColorOperator extends AbstractLineOperator implements FormatOperator {
  private Color color = null;
  
  
	public LineColorOperator(Color color) {
		super();
		this.color = color;
	}
	...
	protected void doApplyTo(ElementFormats format) {
		((LineFormats)format).setLineColor(color);
	}
}