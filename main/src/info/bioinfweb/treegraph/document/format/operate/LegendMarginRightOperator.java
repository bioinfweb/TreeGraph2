 ...
 * @since 2.0.25
 */
public class LegendMarginRightOperator extends AbstractLegendMarginOperator implements FormatOperator {
	public LegendMarginRightOperator(DistanceValue value) {
		super(value);
	}
