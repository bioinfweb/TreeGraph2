...
public class MinTreeDistanceOperator extends AbstractLegendOperator implements FormatOperator {
  private DistanceValue distance;

  
	public MinTreeDistanceOperator(DistanceValue distance) {
		super();
	...
	protected void doApplyTo(ElementFormats format) {
		((LegendFormats)format).getMinTreeDistance().assign(distance);
	}
}