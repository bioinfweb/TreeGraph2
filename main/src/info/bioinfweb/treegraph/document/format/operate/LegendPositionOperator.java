...
public class LegendPositionOperator extends AbstractLegendOperator implements FormatOperator {
  private int position;

  
	public LegendPositionOperator(int position) {
		super();
	...
	protected void doApplyTo(ElementFormats format) {
		((LegendFormats)format).setPosition(position);
	}
}