 ...
 * @since 2.0.25
 */
public class LegendMarginBottomOperator extends AbstractLegendMarginOperator implements FormatOperator {
	public LegendMarginBottomOperator(DistanceValue value) {
		super(value);
	}
	...
	protected void applyTo(Margin margin) {
		margin.getLeft().assign(getValue());
	}
}