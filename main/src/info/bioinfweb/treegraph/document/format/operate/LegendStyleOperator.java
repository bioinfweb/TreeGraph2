...
public class LegendStyleOperator extends AbstractLegendOperator implements FormatOperator {
  private LegendStyle style = null;

  
	public LegendStyleOperator(LegendStyle style) {
		super();
		this.style = style;
	}
	...
	protected void doApplyTo(ElementFormats format) {
		((LegendFormats)format).setLegendStyle(style);
	}
}