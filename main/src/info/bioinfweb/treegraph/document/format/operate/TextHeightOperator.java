...
public class TextHeightOperator extends AbstractTextOperator implements FormatOperator {
  private DistanceValue textHeight = null;
	...
	protected void doApplyTo(ElementFormats format) {
		((TextFormats)format).getTextHeight().assign(textHeight);
	}
}