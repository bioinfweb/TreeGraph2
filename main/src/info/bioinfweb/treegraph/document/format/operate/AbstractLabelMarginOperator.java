 ...
 * @since 2.0.25
 */
public abstract class AbstractLabelMarginOperator extends AbstractMarginOperator implements FormatOperator {
	...
	public void applyTo(ElementFormats format) throws InvalidTargetException {
		applyTo(((LabelFormats)format).getMargin());
	}

	
	public boolean validTarget(ElementFormats format) {
		return format instanceof LabelFormats;
	}
}