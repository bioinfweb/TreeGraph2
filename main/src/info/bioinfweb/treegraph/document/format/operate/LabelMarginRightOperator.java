 ...
 * @since 2.0.25
 */
public class LabelMarginRightOperator extends AbstractLabelMarginOperator implements FormatOperator {
	public LabelMarginRightOperator(DistanceValue value) {
		super(value);
	}
