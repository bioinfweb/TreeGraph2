 ...
 * @since 2.0.25
 */
public abstract class AbstractLeafMarginOperator extends AbstractMarginOperator implements FormatOperator {
	...
	public void applyTo(ElementFormats format) throws InvalidTargetException {
		applyTo(((NodeFormats)format).getLeafMargin());
	}

	
	public boolean validTarget(ElementFormats format) {
		return format instanceof NodeFormats;
	}
}