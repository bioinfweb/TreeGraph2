...
public class ConstantWidthOperator extends AbstractBranchOperator implements FormatOperator {
  private boolean constantWidth;

  
	public ConstantWidthOperator(boolean constantWidth) {
		super();
	...
	protected void doApplyTo(ElementFormats format) {
		((BranchFormats)format).setConstantWidth(constantWidth);
	}
}