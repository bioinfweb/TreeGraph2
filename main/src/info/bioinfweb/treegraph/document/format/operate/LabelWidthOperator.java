 ...
 * @since 2.0.25
 */
public class LabelWidthOperator extends AbstractGraphicalLabelOperator implements FormatOperator {
  private DistanceValue width = null;

  
	public LabelWidthOperator(DistanceValue width) {
		super();
		this.width = width;
	}
	...
	protected void doApplyTo(ElementFormats format) {
		((GraphicalLabelFormats)format).getWidth().assign(width);
	}
}