 ...
 * @since 2.0.25
 */
public class LabelMarginTopOperator extends AbstractLabelMarginOperator implements FormatOperator {
	public LabelMarginTopOperator(DistanceValue value) {
		super(value);
	}
