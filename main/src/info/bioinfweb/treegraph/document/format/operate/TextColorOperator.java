...
public class TextColorOperator extends AbstractTextOperator implements FormatOperator {
  private Color color = null;

  
	public TextColorOperator(Color color) {
		super();
		this.color = color;
	}
	...
	protected void doApplyTo(ElementFormats format) {
		((TextFormats)format).setTextColor(color);
	}
}