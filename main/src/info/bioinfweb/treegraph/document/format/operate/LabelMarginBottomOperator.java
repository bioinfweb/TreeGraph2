 ...
 * @since 2.0.25
 */
public class LabelMarginBottomOperator extends AbstractLabelMarginOperator implements FormatOperator {
	public LabelMarginBottomOperator(DistanceValue value) {
		super(value);
	}
	...
	protected void applyTo(Margin margin) {
		margin.getBottom().assign(getValue());
	}
}