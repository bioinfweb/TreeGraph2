 ...
 * @since 2.0.25
 */
public class IconHeightAdapter extends AbstractIconLabelDistanceAdapter implements DistanceAdapter {
	public IconHeightAdapter(String id) {
		super(id);
	}
	...
	public String toString() {
		return toString("Label icon heights");
	}
}