 ...
 * @since 2.0.25
 */
public class CornerRadiusAdapter extends AbstractDistanceValueAdapter implements DistanceAdapter {
	@Override
	protected DistanceValue getDistanceValue(Node node) {
		return node.getFormats().getCornerRadius();
	}
	

	@Override
	public String toString() {
		return "Corner radius of nodes";
	}
