 ...
 * @since 2.0.25
 */
public class LabelMarginRightAdapter extends AbstractLabelDistanceAdapter implements DistanceAdapter {
	...
	protected DistanceValue getDistanceValue(LabelFormats formats) {
		return formats.getMargin().getRight();
	}

	
	@Override
	public String toString() {
		return toString("Label margin (right)");
	}
}