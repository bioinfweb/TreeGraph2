 ...
 * @since 2.0.25
 */
public class LeafMarginBottomAdapter extends AbstractDistanceValueAdapter implements DistanceAdapter {
	@Override
	protected DistanceValue getDistanceValue(Node node) {
		return node.getFormats().getLeafMargin().getBottom();
	}

	
	@Override
	public String toString() {
		return "Leaf margin (bottom)";
	}
}