 ...
 * @since 2.0.25
 */
public class LeafMarginTopAdapter extends AbstractDistanceValueAdapter implements DistanceAdapter {
	@Override
	protected DistanceValue getDistanceValue(Node node) {
		return node.getFormats().getLeafMargin().getTop();
	}

	
	@Override
	public String toString() {
		return "Leaf margin (top)";
	}
}