 ...
 * @since 2.0.23
 */
public class BranchSpaceBelowAdapter extends AbstractDistanceValueAdapter implements DistanceAdapter {
	@Override
	protected DistanceValue getDistanceValue(Node node) {
		return node.getAfferentBranch().getFormats().getMinSpaceBelow();
	}


	@Override
	public String toString() {
		return "Minimal space below branches";
	}
}