 ...
 * @since 2.0.25
 */
public class LeafMarginLeftAdapter extends AbstractDistanceValueAdapter implements DistanceAdapter {
	@Override
	protected DistanceValue getDistanceValue(Node node) {
		return node.getFormats().getLeafMargin().getLeft();
	}

	
	@Override
	public String toString() {
		return "Leaf margin (left)";
	}
}