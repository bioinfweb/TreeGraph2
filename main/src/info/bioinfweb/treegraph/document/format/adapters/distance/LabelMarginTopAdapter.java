 ...
 * @since 2.0.25
 */
public class LabelMarginTopAdapter extends AbstractLabelDistanceAdapter implements DistanceAdapter {
	public LabelMarginTopAdapter(String id) {
		super(id);
	}
	...
	protected DistanceValue getDistanceValue(LabelFormats formats) {
		return formats.getMargin().getTop();
	}

	
	@Override
	public String toString() {
		return toString("Label margin (top)");
	}
}