 ...
 * @since 2.0.25
 */
public class LegendSpacingAdapter extends AbstractLegendAdapter implements DistanceAdapter {
	@Override
	public DistanceValue getDistanceValue(LegendFormats formats) {
		return formats.getSpacing();
	}
	

	@Override
	public String toString() {
		return "Spacing between legend text and bracket";
	}
}