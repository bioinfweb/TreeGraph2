 ...
 * @since 2.0.23
 */
public class LabelTextHeightAdapter extends AbstractLabelDistanceAdapter implements DistanceAdapter {
	...
	protected DistanceValue getDistanceValue(LabelFormats formats) {
		if (formats instanceof TextLabelFormats) {
			return ((TextLabelFormats)formats).getTextHeight();
		}
		else {
			return null;
		}
