 ...
 * @since 2.0.25
 */
public class LabelMarginLeftAdapter extends AbstractLabelDistanceAdapter implements DistanceAdapter {
	public LabelMarginLeftAdapter(String id) {
		super(id);
	}
	...
	public String toString() {
		return toString("Label margin (left)");
	}
}