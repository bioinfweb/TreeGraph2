 ...
 * @since 2.0.25
 */
public class LeafMarginRightAdapter extends AbstractDistanceValueAdapter implements DistanceAdapter {
	@Override
	protected DistanceValue getDistanceValue(Node node) {
		return node.getFormats().getLeafMargin().getRight();
	}

	
	@Override
	public String toString() {
		return "Leaf margin (right)";
	}
}