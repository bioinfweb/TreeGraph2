 ...
 */
public class NewHiddenNodeDataAdapter extends HiddenNodeDataAdapter
    implements IDElementAdapter, NewNodeBranchDataAdapter {
  	
  public NewHiddenNodeDataAdapter() {
  	super("");
  }
