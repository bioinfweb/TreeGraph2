...
public class HiddenBranchDataAdapter extends HiddenDataAdapter {
	...
	public String getName() {
		return NAME_PREFIX + "hiddenBranchData";
	}


//	@Override
//	protected HiddenDataMap getDataMap(Node node) {
//		return node.getAfferentBranch().getHiddenDataMap();
//	}

	
	@Override
	protected MetadataTree getMetadataTree(Node node) {
		return node.getAfferentBranch().getMetadataTree();
	}
