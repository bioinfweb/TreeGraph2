...
public class GenerateBayesTraitsInputAction extends EditDialogAction<GenerateBayesTraitsInputDialog> {
	...
	@Override
	protected GenerateBayesTraitsInputDialog createDialog() {
