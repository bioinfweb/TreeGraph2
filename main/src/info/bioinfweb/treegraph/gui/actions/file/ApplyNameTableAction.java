...
import info.bioinfweb.treegraph.gui.dialogs.io.ApplyNameTableDialog;
 ...
 */
public class ApplyNameTableAction extends EditDialogAction {
	public ApplyNameTableAction(MainFrame mainFrame) {
		super(mainFrame);
		putValue(Action.NAME, "Apply name table to node/branch data..."); 
	...
	public EditDialog createDialog() {
		return new ApplyNameTableDialog(getMainFrame());
	}
