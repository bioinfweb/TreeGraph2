...
public class CopyColumnDialog extends EditDialog {
	...
	protected boolean onExecute() {
		getSrcInput().setAdapters(getDocument().getTree(), true, true, true, false, false, false);
		if (getSelectedAdapter() != null) {
			getSrcInput().setSelectedAdapter(getSelectedAdapter().getClass());
		}
		getDestInput().setAdapters(getDocument().getTree(), false, true, true, false, true, false);
