...
public class ImportTableDialog extends FileDialog {
	...
	private NodeBranchDataInput nodeIdentifierInput;
	...
	private JPanel getNodeIdentificationPanel() {
		if (nodeIdentificationPanel == null) {
			...
			gbc_nodeIdentifierLabel.anchor = GridBagConstraints.EAST;
	...
	private JLabel getNodeIdentifierLabel() {
		if (nodeIdentifierLabel == null) {
			nodeIdentifierLabel = new JLabel("Node/branch data column to identify tree nodes: ");
		}
	...
	private JCheckBox getColumnHeadingsCheckBox() {
		if (columnHeadingsCheckBox == null) {
			columnHeadingsCheckBox = new JCheckBox("First parsed line contains column headings");
		}
	...
	private NodeBranchDataInput getNodeIdentifierInput() {
		if (nodeIdentifierInput == null) {
			getNodeIdentificationPanel();
		}
		return nodeIdentifierInput;
	}
}