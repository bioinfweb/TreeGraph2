...
public class DecimalFormatPanel extends JPanel implements ElementFormatTab {
	...
	private JTable getPredifinedTable() {
		if (predifinedTable == null) {
			...
			predifinedTable.getSelectionModel().addListSelectionListener(new ListSelectionListener() {  //TODO Muss zus�tzlich auch ein Model-Listener her? Muss der Tastenstatus initielisiert werden?
