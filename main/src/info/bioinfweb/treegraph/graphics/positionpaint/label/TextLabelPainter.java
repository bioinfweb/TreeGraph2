...
public class TextLabelPainter implements LabelPainter<TextLabel> {
	@Override
	public DistanceDimension calculateDimension(TextLabel label) {
		return RectangularCladogramPositioner.calculateTextDimension(label);
	}

	
	@Override
	public void paint(Graphics2D g, float pixelsPerMillimeter, PositionData pd, TextLabel label) {
