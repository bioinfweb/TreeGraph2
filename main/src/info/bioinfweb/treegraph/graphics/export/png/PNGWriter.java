 ...
 */
package info.bioinfweb.treegraph.graphics.export.png;
...
public class PNGWriter extends SVGTranscodeWriter implements GraphicWriter {
	public PNGWriter() {
		super(PNGTranscoder.class);
	}
}