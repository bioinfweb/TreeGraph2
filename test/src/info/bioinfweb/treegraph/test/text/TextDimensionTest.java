...
public class TextDimensionTest {
	public static void main(String[] args) {
		final float pixelsPerMillimeter = 1f;
	  ...
	  textElement.getFormats().setFontName("Arial");
	  //textElement.getFormats().setFontName("Arial Black");
	  //textElement.getFormats().setFontName("Courier New");
	  ...
	  System.out.println(dim.getWidth().getInPixels(pixelsPerMillimeter) + " " + paintWidth + " " + widthFromScaledHeight);
	  
	  // Warum weichen Arial und Arial Black in verschiedene Richtungen voneinander ab?
